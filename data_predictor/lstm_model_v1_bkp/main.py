...
def convert_to_ngsild_format(row, model_id):
    ...
    traffic_data["predictedAverageVehicleSpeed"] = {
        ...
        "observedAt": observed_at,
        "unitCode": "KMH",
        "datasetId": f"urn:ngsi-ld:Dataset:{model_id}",
        "predictedBy": {
            "type": "Relationship",
            "object": f"urn:ngsi-ld:DataServiceProcessing:TrafficFlowPrediction:{model_id}",
        },
...
async def predict_with_ecomob_model(
    ...
    if data is not None:
        ...
        data_end_datetime = datetime.fromisoformat(parse_data.index.max())
...
if __name__ == "__main__":
    ...
    area_code = "ILM_92130_4925"
    future_datetime = "2024-06-01T00:00:00Z"
    look_back = 1440
